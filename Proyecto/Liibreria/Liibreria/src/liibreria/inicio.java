...
public class inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/liibreria/libros.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
           String suc = JOptionPane.showInputDialog(null,
                    "Ingrese numero de sucursal", "LIBRERIA",
                    JOptionPane.INFORMATION_MESSAGE);
                
                    if(suc!=null)
                new compra(Integer.parseInt(suc)).setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new seccont().setVisible(true);
